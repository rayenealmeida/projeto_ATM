...
button_menu = tk.Button(janela, text= '1', width=2)
button_menu.pack()
button_menu.place(x=113, y=404)

button_menu = tk.Button(janela, text= '2', width=2, command=abrir_saque)
button_menu.pack()
button_menu.place(x=166, y=404)

button_menu = tk.Button(janela, text= '3', width=2)
button_menu.pack()
button_menu.place(x=219, y=404)

button_menu = tk.Button(janela, text= '4', width=2)
button_menu.pack()
button_menu.place(x=113, y=440)

button_menu = tk.Button(janela, text= '5', width=2)
button_menu.pack()
button_menu.place(x=166, y=440)

button_menu = tk.Button(janela, text= '6', width=2)
button_menu.pack()
button_menu.place(x=219, y=440)

button_menu = tk.Button(janela, text= '7', width=2)
button_menu.pack()
button_menu.place(x=113, y=476)

button_menu = tk.Button(janela, text= '8', width=2)
button_menu.pack()
button_menu.place(x=166, y=476)

button_menu = tk.Button(janela, text= '9', width=2)
button_menu.pack()
button_menu.place(x=219, y=476)

button_menu = tk.Button(janela, text= '0', width=2)
button_menu.pack()
